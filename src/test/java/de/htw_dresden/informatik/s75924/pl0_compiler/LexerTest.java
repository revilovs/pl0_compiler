...
public class LexerTest {
    ...
    public void lexT2correctly(){
        try {
            ...
            //var a,b,Max;
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.VAR.value, 1, 0));
            ...
            // procedure p1;
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.PROCEDURE.value, 2, 1));
            expectedTokens.add(new Token(Token.TokenType.IDENTIFIER, "P1", 2, 11));
            expectedTokens.add(new Token(Token.TokenType.SYMBOL, ';', 2, 13));

            // begin
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.BEGIN.value, 3, 1));

            //   if a>=b then Max:=a;
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.IF.value, 4, 3));
            expectedTokens.add(new Token(Token.TokenType.IDENTIFIER, "A", 4, 6));
            expectedTokens.add(new Token(Token.TokenType.SYMBOL, CharValues.GREATER_OR_EQUAL.value, 4, 7));
            expectedTokens.add(new Token(Token.TokenType.IDENTIFIER, "B", 4, 9));
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.THEN.value, 4, 11));
            expectedTokens.add(new Token(Token.TokenType.IDENTIFIER, "MAX", 4, 15));
            expectedTokens.add(new Token(Token.TokenType.SYMBOL, CharValues.ASSIGN.value, 4, 18));
            expectedTokens.add(new Token(Token.TokenType.IDENTIFIER, "A", 4, 20));
            expectedTokens.add(new Token(Token.TokenType.SYMBOL, ';', 4, 21));

            //   if a< b then Max:=b
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.IF.value, 5, 3));
            ...
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.THEN.value, 5, 11));
            expectedTokens.add(new Token(Token.TokenType.IDENTIFIER, "MAX", 5, 15));
            expectedTokens.add(new Token(Token.TokenType.SYMBOL, CharValues.ASSIGN.value, 5, 18));
            expectedTokens.add(new Token(Token.TokenType.IDENTIFIER, "B", 5, 20));

            // end;
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.END.value, 6, 1));
            expectedTokens.add(new Token(Token.TokenType.SYMBOL, ';', 6, 4));

            // begin
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.BEGIN.value, 7, 1));
            ...
            //   call p1;
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.CALL.value, 9, 3));
            ...
            // end.
            expectedTokens.add(new Token(Token.TokenType.KEYWORD, CharValues.END.value, 11, 1));
